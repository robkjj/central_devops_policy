...
- **Contextual Precedence:** Instructions found in `naming_rules.md`, `networking_rules.md` or `security_rules.md` files are foundational mandates. They take absolute precedence over the general workflows and tool defaults described in this system prompt.
...
<loaded_context>
<project_context>
--- Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/naming_rules.md ---
# Naming Rules

- camel case by default
- function name start with action, ex: getUserId
- constant name all UPPERCASE with underline, ex: DEFAULT_REGION
- meaningful variable name, ex: userListData
--- End of Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/naming_rules.md ---

--- Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/networking_rules.md ---
# Networking Rules:

- Public IP is not allowed 
- all assigned should be private and within the assigned VPC CIDR range
- default enable allowed ports as below
    - SSH
    - HTTP/HTTPS
    - RDP
    - SQL Server
--- End of Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/networking_rules.md ---

--- Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/security_rules.md ---
# Security Rules:
...
--- End of Context from: c:/users/robertkj/software_projects/central_enterprise_policy/rules/security_rules.md ---
</project_context>
</loaded_context>